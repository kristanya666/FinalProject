...
### 7. Покупка тура с вводом прошедшего месяца текущего года: ###

Входные данные:

Номер карты - _4444 4444 4444 4441_;   
Дата - _любой месяц, кроме текущего и предыдущего/ текущий год;_     
CVC/CVV - _123_;   
Владелец - _IVAN IVANOV_.
...
### 8. Покупка тура с вводом прошлого года: ###
...
### 9. Покупка тура с с вводом месяца, который предшествует текущему месяцу: ###
...
### 10. Покупка тура с вводом даты, где месяц под номером 13: ###
...
### 11. Покупка тура с вводом даты, где месяц имеет нулевое значение: ###
...
### 12. Покупка тура с вводом даты, где год имеет нулевое значение: ###
...
### 13. Покупка тура с вводом даты с пустым значением: ###
...
### 14. Покупка тура с вводом даты, где месяц с пустым значением: ###
...
### 15. Покупка тура с вводом даты, где год с пустым значением: ###
...
### 16. Покупка тура с вводом даты, где год на 6 лет больше текущего: ###
...
### 17. Покупка тура с вводом специсимволов в поле даты: ###
...
### 18. Покупка тура с вводом одной цифры в поле даты: ###
...
### 19. Покупка тура с вводом имени владельца кириллицей: ###
...
### 20. Покупка тура с вводом цифр в поле Имя Владельца: ###
...
### 21. Покупка тура с вводом одной буквы в поле Имя Владельца: ###
...
### 22. Покупка тура с вводом спецсимволов в поле Имя Владельца: ###
...
### 23. Покупка тура с пустым значением в поле Имя Владельца: ###
...
### 24. Покупка тура с вводом нулевого CVC/CVV: ###
...
### 25. Покупка тура с вводом CVC/CVV из одной цифры: ###
...
### 26. Покупка тура с пустым значением CVC/CVV : ###
...
### 27. Покупка тура с вводом букв в поле CVC/CVV : ###
...
### 28. Покупка тура с вводом спецсимволов в поле CVC/CVV : ###
...
### 29. Покупка тура с пустыми значениями во всех полях: ###
...
### 30. Покупка тура с рандомным  16-тизначным числом в поле Номер карты ###
