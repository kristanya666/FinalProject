...
### 8. Покупка тура с вводом даты, где месяц имеет нулевое значение: ###
...
### 9. Покупка тура с вводом даты, где год имеет нулевое значение: ###
...
### 10. Покупка тура с вводом даты с пустым значением: ###
...
### 26. Покупка тура с рандомным  16-тизначным числом в поле Номер карты ###
