...
### 3. Покупка тура с рандомным  16-тизначным числом в поле Номер карты ###
...
### 1. Покупка тура с "DECLINED" картой: ###
...
### 2. Покупка тура с вводом карты с одной цифрой: ###
...
### 3. Покупка тура с пустым полем карты: ###
...
### 4. Покупка тура с полем карты, заполненным нолями: ###
...
### 5. Покупка тура с вводом прошедшей даты: ###
...
### 6. Покупка тура с с вводом месяца, который предшествует текущему месяцу: ###
...
### 7. Покупка тура с вводом даты, где месяц под номером 13: ###
...
### 8. Покупка тура с вводом даты, где месяц и год нулевые значения: ###
...
### 9. Покупка тура с вводом даты с пустым значением: ###
...
### 10. Покупка тура с вводом даты, где месяц с пустым значением: ###
...
### 11. Покупка тура с вводом даты, где год с пустым значением: ###
...
### 12. Покупка тура с вводом даты, где год на 6 лет больше текущего: ###
...
### 13. Покупка тура с вводом специсимволов в поле даты: ###
...
### 14. Покупка тура с вводом одной цифры в поле даты: ###
...
### 15. Покупка тура с вводом имени владельца кириллицей: ###
...
### 16. Покупка тура с вводом цифр в поле Имя Владельца: ###
...
### 17. Покупка тура с вводом одной буквы в поле Имя Владельца: ###
...
### 18. Покупка тура с вводом спецсимволов в поле Имя Владельца: ###
...
### 19. Покупка тура с пустым значением в поле Имя Владельца: ###
...
### 20. Покупка тура с вводом нулевого CVC/CVV: ###
...
### 21. Покупка тура с вводом CVC/CVV из одной цифры: ###
...
### 22. Покупка тура с пустым значением CVC/CVV : ###
...
### 23. Покупка тура с вводом букв в поле CVC/CVV : ###
...
### 24. Покупка тура с вводом спецсимволов в поле CVC/CVV : ###
...
### 25. Покупка тура с пустыми значениями во всех полях: ###
...
### 26. Покупка тура с пустыми значениями во всех полях кроме номера карты: ###
...
Под пустыми полями выйдет подсказка "Неверный формат", а под полем Имя Владельца - "Поле обязательно для заполнения"
...
1. Оплата APPROVED картой в разделе "Купить"
...
2. Оплата DECLINED картой  в разделе "Купить"
